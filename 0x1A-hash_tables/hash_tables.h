 ...
 * because we want our tabla to use a Chaining collision handling
 */
 ...
 *
 * @key: The key, string
 * The key is unique in the tabla
 ...
 * Each cell of ce array is pointer to first node of linked list,
 * because we want our tabla to use chaining collision handling
